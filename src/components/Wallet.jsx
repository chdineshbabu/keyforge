...
import { AccountContext, AccountCountContext, SeedContext } from "@/app/context/WalletContextProvider";
...
function Wallet() {
  ...
  const addAccount =()=>{
    ...
    console.log(pubKey,pvtKey,secKey)
    setAccount((prevItems) => [...prevItems, {pub:pubKey,pvt:base64Encoded,sec:secKey}])
  ...
  return (
    <div className="py-8">
      <div className="flex justify-between items-center">
        ...
        <button onClick={addAccount} className="border p-2 rounded-md hover:bg-slate-300 hover:text-black">New Account</button>
      </div>
      <div>
      {accountCount === 0 ? <div className='text-xl font-extralight p-6 text-center'>No Accounts</div>: <><Account accounts={account}/></>}
